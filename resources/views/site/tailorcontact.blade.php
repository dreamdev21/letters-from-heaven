    ...
    <section id="stories" class="sections" style="font-family:libre baskerville,serif;background-color: #F9F9F9;">
        <div class="container" id="ourteam">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12"
                    ...
                    <div class="header-details">
                        <h1 style="letter-spacing: 6px;">Concierge - Tailored Service</h1>
                    </div>
                </div>
                <div class="container row text-center">
                    <img src="/site/images/contact.jpg">
                </div>
            </div>
            ...
            <div class="row text-center"
                ...
                <div class="header-details">
                    <h1 style="margin-top: 3rem;margin-bottom: 3rem;">​Be in Touch</h1>
                    <p style="font-size: 14px;font-weight:lighter;    color: rgba(0, 0, 0, 0.72);">I'm a paragraph.
                        Click here to add your own text and edit me. It’s easy. Just click “Edit Text” or<br> double
                        click me to add your own content and make changes to the font. I’m a great place for you to<br>
            ...
            <div class="container col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 text-center">
                ...
                @endif
                {{ Form::open(['method' => 'post','route' => ['tailorcontact/save'],'style'=>'display:inline','class'=>'form-horizontal']) }}
