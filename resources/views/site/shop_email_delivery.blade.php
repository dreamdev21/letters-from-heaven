...
@section('content')
    ...
    <section id="email_choose" class="sections" style="margin-top: 12rem;margin-bottom:10rem;color: #7cc2cb">
        {{ Form::open(['method' => 'get','route' => ['/shop/email/addcart'],'style'=>'display:inline','class'=>'form-horizontal','id'=>'textcontent']) }}
        {{ csrf_field() }}
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-xs-6 text-left" style="padding-left: 0px !important;">
                            <input type="button" class="btn-addcart" value="SAVE AS DRAFT" id="add-cart" onclick="draft()">
                        </div>
                        <div class="col-xs-6 text-right" style="padding-right: 0px !important;">
                            <input type="button" class="btn-addcart" value="ADD TO CART" id="add-cart" onclick="addtocart()">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        function addtocart(){
            $('#textcontent').append('<input type = "hidden" name = "draft" value = "1">');
            var text = $('.Editor-editor').html();
            $('#textcontent').append('<input type = "hidden" name = "textcontent" value = "'+text+'">');
            $('#textcontent').submit();
        }
