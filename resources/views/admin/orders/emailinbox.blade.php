                        ...
                        <ul class="nav nav-second-level">
                            <li class="active">
                                ...
                                <ul class="nav nav-third-level">
                                    <li class="active"><a href="{{ route('order/email/inbox') }}">Email</a></li>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="row text-center">
                                                            <a href="/admin/order/email/goprint/{{ $item->id }}" style="background-color: lightgreen;    color: white;    padding: 14px 25px;    text-align: center;    text-decoration: none;    display: inline-block;">Downlaod PDF</a>
                                                        </div>
                                                    </div>
                                                </div>
