                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li  class="active">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li  class="active"><a href="{{ route('flower/deletebox') }}">Deletebox</a></li>
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6 ">
                                    {{ Form::open(['method' => 'Update','route' => ['flower/template/update', $template->id],'style'=>'display:inline','class'=>'form-horizontal']) }}
                            ...
                            <div class="row">
                                @for ($i=1;$i<20;$i++)
                                    <div class="col-md-3"><h5>Image{{ $i }}</h5>
                                        <img src="{{ asset('images/') }}/{{$template['image'.$i]}}" style="width: 10rem;height: 10rem;">
                                    </div>
                                @endfor
                    ...
                    <div class="row">
                        <div class="col-sm-12"><h3 class="m-t-none m-b" style="text-align: center">Upload New
                            ...
                            <form class="form-horizontal" role="form" method="POST"
                                ...
                                @for ($i=1;$i<20;$i++)
                                    <div class="form-group">
                                        <label for="file" class="col-md-4 control-label">Image{{ $i }} : </label>

                                        <div class="col-md-6">
                                            <input id="image" type="file" class="form-control" name="image{{ $i }}"
                                                   value=""
                                                   required autofocus>
